...
namespace EMRIntegrations.Data
{
    public sealed class SqlHelper
    {
        ...
        public static bool TestSQLConnection(string ConnSting)
        {
            try
            {
                SqlConnection sqlCon = new SqlConnection(ConnSting);
                sqlCon.Open();
                sqlCon.Close();
            }
            catch
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, DataTable dtGrammar)
        {
            foreach (DataRow dRow in dtGrammar.Rows)
            {
                commandText = commandText.Replace("<" + dRow["Key"].ToString() + ">", dRow["Values"].ToString());
            }
            return ExecuteNonQuery(connectionString, commandType, commandText, (SqlParameter[])null);
        }
        ...
        public static DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText, DataTable dtGrammar)
        {
            foreach (DataRow dRow in dtGrammar.Rows)
            {
                commandText = commandText.Replace("<" + dRow["Key"].ToString() + ">", dRow["Values"].ToString());
        ...
        public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            //Done to avoid SP_TimeOut Problem
            PrepareCommand(cmd, connection, null, commandType, commandText, commandParameters, ref mustCloseConnection);
