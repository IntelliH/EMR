...
@PowerShell "Import-Module WebAdministration; Remove-Website -Name 'Default Web Site'; New-Website -Name 'webapp' -Port 80 -PhysicalPath 'C:\inetpub\wwwroot\webapp' -Force; Start-Website -Name webapp; Get-ChildItem -Path IIS:\Sites"
