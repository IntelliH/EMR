using EMRIntegrations.CernerMillenium.ModuleClasses;
using System;
using System.Collections;
using System.Data;

namespace EMRIntegrations.CernerMillenium
{
    public class CernerMilleniumAPI
    {
        ...
        public void SavePatientDemographics(DataTable dtPatientDemographics, string stagingdbconnectionstring, string requestid)
        {
            ...
            {
                Common objCommon = new Common();
                objCommon.InsertRecords(dtPatientDemographics, "CernerMillenium.PatientDemographics", stagingdbconnectionstring, requestid);
            }
            catch (Exception)
            {
                throw;
        ...
        public void SaveMedications(DataTable dtMedications, string stagingdbconnectionstring, string requestid)
        {
            ...
            {
                Common objCommon = new Common();
                objCommon.InsertRecords(dtMedications, "CernerMillenium.Medications", stagingdbconnectionstring, requestid);
            }
            catch (Exception)
            {
                throw;
        ...
        public void SaveAllergy(DataTable dtAllergy, string stagingdbconnectionstring, string requestid)
        {
            ...
            {
                Common objCommon = new Common();
                objCommon.InsertRecords(dtAllergy, "CernerMillenium.Allergy", stagingdbconnectionstring, requestid);
            }
            catch (Exception)
            {
                throw;
