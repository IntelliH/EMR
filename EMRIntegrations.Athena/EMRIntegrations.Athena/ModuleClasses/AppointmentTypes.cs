    ...
    public class AppointmentTypes
    {
        ...
        public DataTable GetData(Hashtable parameters)
        {
            try
            {
                ...
                {
                    default:
                        dtModuleData = GetAppointmentTypesData(parameters);
                        break;
                }
                return dtModuleData;
            }
        ...
        private DataTable GetAppointmentTypesData(Hashtable parameters)
        {
            try
            {
                string strModuleName = string.Empty;
                strModuleName = "AppointmentTypes";
                ...
                foreach (var value in arydept)
                {
                    ...
                    jobj = (JObject)api.GET("appointmenttypes", appbook);
                    jtobj = jobj["appointmenttypes"];
                    if (jtobj != null)
                    {
