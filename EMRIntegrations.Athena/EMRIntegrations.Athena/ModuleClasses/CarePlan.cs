    ...
    public class CarePlan
    {
        ...
        public DataTable GetData(Hashtable parameters)
        {
            try
            {
                ...
                {
                    default:
                        dtModuleData = GetCarePlanData(parameters);
                        break;
                }
                return dtModuleData;
            }
        ...
        private DataTable GetCarePlanData(Hashtable parameters)
        {
            try
            {
                string strModuleName = string.Empty;
                strModuleName = "CarePlan";
                ...
                foreach (var value in arydept)
                {
                    ...
                    jobj = (JObject)api.GET("ccda/" + parameters["patientid"].ToString() + "/patientcareplan", dirlst);
                    jtobj = jobj["patientcareplan"];
                    if (jtobj != null)
                    {
