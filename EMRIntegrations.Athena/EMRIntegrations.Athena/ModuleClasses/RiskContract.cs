    ...
    public class RiskContract
    {
        ...
        public DataTable GetData(Hashtable parameters)
        {
            try
            {
                ...
                {
                    default:
                        dtModuleData = GetRiskContractData(parameters);
                        break;
                }
                return dtModuleData;
            }
        ...
        private DataTable GetRiskContractData(Hashtable parameters)
        {
            try
            {
                string strModuleName = string.Empty;
                strModuleName = "RiskContract";
                ...
                foreach (var value in arydept)
                {
                    ...
                    jobj = (JObject)api.GET("chart/" + parameters["patientid"].ToString() + "/riskcontract", appbook);
                    jtobj = jobj["riskcontract"];
                    if (jtobj != null)
                    {
