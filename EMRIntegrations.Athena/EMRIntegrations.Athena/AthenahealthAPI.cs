...
namespace EMRIntegrations.Athena
{
    ...
    public class APIConnection
    {
        ...
        public APIConnection(string baseUrl, string version, string key, string secret, string practiceid = "")
        {
            ...
            this.baseUrl = baseUrl; //"https://api.athenahealth.com/";
            ...
            Dictionary<string, string> parameters = new Dictionary<string, string>()
        {
          {"grant_type", "client_credentials"},
            ...
            //object authorization = object.Parse(reader.ReadToEnd());
            //object   authorization=        reader.ReadToEnd();
            string authorization = reader.ReadToEnd();
            dynamic jsonResponse = JsonConvert.DeserializeObject(authorization);
            // string _Name = sData["access_token"].ToString();
            ...
            // Grab the token!
            this.token = jsonResponse["access_token"].ToString();// authorization["access_token"];
            response.Close();
        }
